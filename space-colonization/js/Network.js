...
import KDBush from "https://cdn.jsdelivr.net/npm/kdbush@3.0.0/+esm";
// import * as Vec2 from "https://cdn.jsdelivr.net/npm/vec2@1.6.1/vec2.min.js";
...
export default class Network {
  ...
  draw() {
    ...
    this.drawObstacles();
    this.drawNodes();
    this.drawattractors();  // Moved attractors to last so they appear on top
  }
  ...
  getClosestNode(attractor, nearbyNodes) {
    ...
    for(let node of nearbyNodes) {
      // Create proper Vec2 instances for the calculation
      let nodePos = new Vec2(node.position.x, node.position.y);
      let attractorPos = new Vec2(attractor.position.x, attractor.position.y);
      let distance = nodePos.distance(attractorPos);
  ...
  getAverageDirection(node, nearbyattractors) {
    ...
    for(let attractor of nearbyattractors) {
      ...
      averageDirection.add(
        attractorPos.subtract(nodePos, true).normalize()
      );
    }
