...
// import Vec2 from 'https://raw.githubusercontent.com/tmpvar/vec2.js/master/vec2.js';
...
export function applyNoise(attractors) {
  ...
  for(let attractor of attractors) {
    ...
    attractor.position.y += noise.noise2D(attractor.position.x, attractor.position.y) * 10;
  }
